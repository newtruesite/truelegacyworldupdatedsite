-- Migration: Add persistent purchase_links to crm_distributors and update RPC functions

ALTER TABLE public.crm_distributors
ADD COLUMN IF NOT EXISTS purchase_links JSONB DEFAULT '{}'::jsonb;

-- Update get_public_crm_distributors to include purchase_links
...
AS $$
  SELECT 
    ...
    COALESCE(d.purchase_links, '{}'::jsonb) AS purchase_links
...
-- Update crm_update_distributor_profile to accept and save purchaseLinks
...
BEGIN
  ...
  SET display_name = normalized_name,
      ...
      purchase_links = COALESCE(normalized_purchase_links, purchase_links, '{}'::jsonb)
