...
const VARIANTS: Record<LandingVariant, {
  ...
  emguarde: {
    eyebrow: 'Patented EMF Harmonization',
    headline: (name) => `Harmonize Your Environment with ${name}`,
    subheadline: 'Learn how emGuarde harmonizes electro smoke and electromagnetic radiation noise across a 3-meter radius without blocking wireless signals.',
    interest: 'duo',
    icon: Radio,
  },
  training: {
