      ...
      <main className="content-wrapper">
        ...
        <section className="relative overflow-hidden bg-black py-20 md:py-28">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2">
            ...
            <div className="relative mx-auto w-full max-w-xl"><div className="absolute inset-10 rounded-full bg-cyan-400/20 blur-3xl"/><div className="relative grid grid-cols-2 items-end gap-4 rounded-[2rem] border border-white/10 bg-white/[.04] p-5 sm:p-8"><Link to="/usa/k8" onClick={()=>trackEvent('video_click',{video:'water_demo',locale})} className="group flex h-full flex-col justify-end rounded-[1.5rem] border border-transparent p-3 transition-all duration-300 hover:-translate-y-2 hover:border-cyan-500/30 hover:bg-white/[0.06] hover:shadow-[0_0_30px_rgba(6,182,212,0.15)]"><img src="/products/k8.png" alt="K8 flagship Kangen Water ionizer" className="mx-auto max-h-[390px] w-full object-contain drop-shadow-2xl transition duration-500 group-hover:scale-[1.05]"/><p className="mt-4 text-center font-bold text-white">K8 Flagship</p><div className="mt-3 inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-cyan-500 px-3 text-center text-xs font-bold text-slate-950 sm:text-sm group-hover:bg-cyan-400 transition duration-300"><PlayCircle className="h-4 w-4"/>{homeLocalized.waterDemo}</div></Link><Link to="/usa/emguarde" onClick={()=>trackEvent('video_click',{video:'emguarde_go',locale})} className="group flex h-full flex-col justify-end rounded-[1.5rem] border border-transparent p-3 transition-all duration-300 hover:-translate-y-2 hover:border-purple-500/30 hover:bg-white/[0.06] hover:shadow-[0_0_30px_rgba(168,85,247,0.15)]"><img src="/products/emguarde-go.png" alt="emGuarde GO product set" className="mx-auto max-h-[310px] w-full object-contain drop-shadow-2xl transition duration-500 group-hover:scale-[1.05]"/><p className="mt-4 text-center font-bold text-white">emGuarde GO</p><div className="mt-3 inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/5 px-3 text-center text-xs font-bold text-white sm:text-sm group-hover:bg-white/10 group-hover:border-white/40 transition duration-300"><PlayCircle className="h-4 w-4"/>emGuarde GO</div></Link></div></div>
          </div>
        </section>
