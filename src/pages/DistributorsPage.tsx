...
function DistributorCard({
  ...
  return (
    ...
    >
      <div className="shrink-0 w-full sm:w-56 h-72 sm:h-96 rounded-2xl border-4 border-white/20 overflow-hidden bg-cyan-500/10 flex items-center justify-center">
        {!imgError ? (
          <img
            src={dist.photo}
            alt={dist.name}
