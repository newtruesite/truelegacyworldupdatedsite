        ...
        <section className="py-12 md:py-16" style={{ background: '#070c1a' }}>
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-8">
            {DISTRIBUTORS.map((dist, index) => (
              <DistributorCard key={dist.name} dist={dist} index={index} whatsappLabel={whatsappLabel} websiteLabel={websiteLabel} />
            ))}
          </div>
        </section>
      </main>
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          {dist.whatsapp && (
            <a href={dist.whatsapp} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold px-4 py-3 text-sm min-h-[44px] transition-colors">
          ...
          {dist.telegram && (
            <a href={dist.telegram} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#229ED9] hover:bg-[#1E8BC7] text-white font-semibold px-4 py-3 text-sm min-h-[44px] transition-colors">
