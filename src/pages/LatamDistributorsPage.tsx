...
const DISTRIBUTORS: Distributor[] = [
  ...
  },
  {
    ...
    photo: "/leaders/magaly-hero.png",
    fallbackInitial: "M",
    whatsapp: "https://wa.me/18642108298",
    telegram: "https://t.me/+18642018298",
  ...
  },
  {
    ...
    fallbackInitial: "R",
    whatsapp: "https://wa.me/12137336186",
    instagram: "https://www.instagram.com/ocbbullet/",
    telegram: "https://t.me/+12137336286",
    region: "Global",
  },
];
...
function DistributorCard({
  ...
  return (
    ...
    >
      <div className="shrink-0 w-full sm:w-56 h-[460px] sm:h-[350px] md:h-[420px] rounded-2xl border-4 border-white/20 overflow-hidden bg-cyan-500/10 flex items-center justify-center">
        {!imgError ? (
          <img
            src={dist.photo}
            alt={dist.name}
