...
export default function AppSharePage(){
  ...
  if(!membership?.active||!distributor)return <Message title="Distributor profile required" body="This account is not connected to an active distributor profile yet."/>
