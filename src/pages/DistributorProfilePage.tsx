            ...
            <div className="relative h-52 shrink-0 overflow-hidden sm:h-60 lg:h-64">
              {item.visual === 'business' && <>
                ...
                <div className="absolute bottom-0 right-[5%] h-[94%] w-[72%] transition duration-700 group-hover:scale-[1.035]">
                  <img src={profileHero} alt="" style={{ height: '100%', width: '100%', objectFit: 'contain', objectPosition: 'center bottom' }} className="drop-shadow-[0_22px_34px_rgba(0,0,0,0.55)]" />
                </div>
              ...
              {item.visual === 'duo' && <>
                ...
                <img src="/products/k8.png" alt="K8 water ionizer" className="absolute bottom-2 left-[10%] h-[78%] w-[45%] object-contain drop-shadow-[0_18px_28px_rgba(0,0,0,0.45)] transition duration-700 group-hover:-translate-x-1 group-hover:scale-105" />
                <img src="/products/emguarde-go.png" alt="emGuarde GO" className="absolute bottom-3 right-[10%] h-[76%] w-[34%] object-contain drop-shadow-[0_18px_28px_rgba(0,0,0,0.55)] transition duration-700 group-hover:translate-x-1 group-hover:scale-105" />
              ...
              {item.visual === 'events' && <>
                ...
                <img src="/assets/event-global-flyer-UKa8W2ck.jpg" alt="True Legacy live event" className="absolute -bottom-[48%] right-[12%] h-[155%] w-auto rotate-2 rounded-xl object-contain shadow-2xl shadow-black/50 transition duration-700 group-hover:-translate-y-1 group-hover:rotate-0 group-hover:scale-[1.03]" />
