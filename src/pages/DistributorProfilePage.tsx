...
export default function DistributorProfilePage() {
  ...
  const languageNames = {
    en: { en: 'English', zh: 'Mandarin', yue: 'Cantonese', ms: 'Malay', es: 'Spanish', fr: 'French', pt: 'Portuguese', ar: 'Arabic', ru: 'Russian' },
    es: { en: 'Inglés', zh: 'Mandarín', yue: 'Cantonés', ms: 'Malayo', es: 'Español', fr: 'Francés', pt: 'Portugués', ar: 'Árabe', ru: 'Ruso' },
    fr: { en: 'Anglais', zh: 'Mandarin', yue: 'Cantonais', ms: 'Malais', es: 'Espagnol', fr: 'Français', pt: 'Portugais', ar: 'Arabe', ru: 'Russe' },
    pt: { en: 'Inglês', zh: 'Mandarim', yue: 'Cantonês', ms: 'Malaio', es: 'Espanhol', fr: 'Francês', pt: 'Português', ar: 'Árabe', ru: 'Russo' },
