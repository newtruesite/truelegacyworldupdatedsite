  ...
  return (
    <div className="page-wrapper bg-black text-white">
      ...
      <main className="mx-auto flex min-h-[65vh] max-w-3xl flex-col items-center justify-center px-4 py-20 text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#2997ff]">404</p>
        <h1 className="mt-4 text-4xl font-bold sm:text-6xl">This page could not be found.</h1>
        <p className="mt-5 max-w-xl text-[#cccccc]">The address may be outdated or incorrect. Return home, explore the products, or find a distributor.</p>
