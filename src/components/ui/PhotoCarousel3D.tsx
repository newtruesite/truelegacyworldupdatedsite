...
const LEADERS = [
    ...
    },
    {
        ...
        bio: [
            'With more than a decade of experience in sales and marketing, Emanuela has built her career around connecting with people, creating opportunities and helping others see what’s possible for their lives.',
