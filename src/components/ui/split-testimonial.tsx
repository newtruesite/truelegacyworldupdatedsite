...
const TESTIMONIALS_RAW = [
    { id: 1, name: 'Doina Rotar', handle: '@doinitarotar', instagramUrl: 'https://www.instagram.com/doinitarotar/', photo: '/assets/testimonials/doina.png', quote: "My name is Doina, and Kangen Water has truly changed my daily life as a single mom living with fibromyalgia. For years, I lived in constant pain, especially in my hands, and nothing I tried seemed to help the inflammation in my body. A friend introduced me to Kangen Water, and even though I couldn't afford the machine upfront, I chose to invest in my health and my kids' future. After a few months of consistency, I began noticing real changes—less pain, more energy, clearer skin, and overall improvement in how I felt. I was even able to stop taking my nerve relaxation medications. Today, I'm in my second year of using my Kangen machine, and I can honestly say it's one of the best investments I've ever made for my health, my children, and my life.", stars: 5, verified: true },
    { id: 2, name: 'Egbert Nah', handle: '@egbertnah', instagramUrl: 'https://www.instagram.com/egbertnah/', photo: '/assets/testimonials/egbert.png', quote: "For 10 years I poured my heart into my food and beverage business, but when COVID hit, I was close to losing everything. The fear of not being able to support my family was overwhelming. Enagic gave me the financial stability and peace of mind I needed to keep going. This journey also pushed me to grow as a person, helping me recognize my strengths, face my weaknesses, and understand that success comes from believing in yourself and surrounding yourself with the right team. Enagic isn't just a business; it's an opportunity that truly transforms lives.", stars: 5, verified: true },
    { id: 3, name: 'Mok E Lin', handle: '@elinmok98', instagramUrl: 'https://www.instagram.com/elinmok98/', photo: '/assets/testimonials/mok.png', quote: "After graduating, I entered the fast-paced world of stock trading and landed a high-paying job that many people would envy. But despite the financial success, something still felt missing. In my search for purpose, I discovered True Legacy through Coach Simon, an opportunity to make a real difference. Today, I travel the world as a global emGuarde distributor, sharing a mission of protection and empowerment for people.", stars: 5, verified: true },
    { id: 4, name: 'Nigara Ismailova', handle: '@nigara.ismail', instagramUrl: 'https://www.instagram.com/nigara.ismail/', photo: '/assets/testimonials/nigara.png', quote: "Through hard work, focus, and faith, I was able to regain financial stability and discover a new sense of purpose. Today, almost 10 years later, I've not only transformed my health and my finances, but I've also been able to help others do the same around the world. This business gave me back hope. If I could move forward, you can too. You just need to take that first step.", stars: 5, verified: true },
    { id: 5, name: 'Ryan Pool', handle: '@ocbbullet', instagramUrl: 'https://www.instagram.com/ocbbullet/', photo: '/assets/testimonials/ryan.png', quote: "My journey with Kangen Water began as a search for better health and wiser choices. I was tired of overpaying for water that wasn't helping me feel my best. After staying consistent, I saw real changes—better mood, more energy, less fatigue, and less inflammation. What started as a health decision became a bigger opportunity, and I trusted the process knowing I was stepping into something aligned and purposeful.", stars: 5, verified: true },
    { id: 6, name: 'Sofia Cohen', handle: '@moroccanprincess91', instagramUrl: 'https://www.instagram.com/moroccanprincess91/', photo: '/assets/testimonials/sofia.png', quote: "My name is Sofia, and nine years ago I made a decision that changed my life. Purchasing my Kangen Water machine became part of my healing journey. After years of inflammation, digestive, and skin issues, drinking Kangen Water daily helped me notice real changes: less inflammation, better digestion, and the feeling that my body was finally being supported. This water became part of my lifestyle and continues to support my healing, awareness, and growth.", stars: 5, verified: true },
    { id: 7, name: 'Thomas & Kristen Sinner', handle: '@thomas_sinner', instagramUrl: 'https://www.instagram.com/thomas_sinner/', photo: '/assets/testimonials/thomas-kristen.png', quote: "We got started with Enagic about 5 years ago with the goal of helping our family. Through that decision we have been blessed to help almost 200 other families. Can't wait to see what the future holds.", stars: 5, verified: true },
    { id: 8, name: 'Zah Naderi', handle: '@zahphysique', instagramUrl: 'https://www.instagram.com/zahphysique/', photo: '/assets/testimonials/zah.png', quote: "Growing up in Pakistan, I had the odds stacked against me from being an out-of-shape kid with big dreams to becoming a refugee. After 11 years of relentless dedication to my health, I transformed my body and mindset. Enagic's K8 technology was the missing piece that elevated my health to the next level. Now, I'm passionate about helping others craft their own wellness legacy.", stars: 5, verified: true },
    { id: 9, name: 'Veronica Calafat', handle: '@vero.calafat', instagramUrl: 'https://www.instagram.com/vero.calafat/', photo: '/assets/testimonials/veronica.png', quote: "I'm very grateful to have discovered Kangen Water. At first, I didn't pay much attention because I didn't fully understand what it was, but two months later I attended a demonstration and everything clicked, so I decided to purchase the machine right there. After a few months of drinking Kangen Water consistently, I began to notice real changes: a clearer mind, more energy, and an overall sense of well-being. That's when I realized I hadn't just bought a machine, but a different way of taking care of my health from the inside out.", stars: 5, verified: true },
]
            ...
            <div className="mt-8 mb-6 flex flex-col items-center gap-4">
                <div className="flex flex-row items-center justify-center gap-3 sm:gap-4 flex-nowrap testimonial-nav-row w-full overflow-x-auto custom-scrollbar px-4">
                    ...
                    >
                        ...
                        <span>{locale === 'es' ? 'Anterior' : locale === 'fr' ? 'Précédent' : locale === 'pt' ? 'Anterior' : 'Previous'}</span>
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        <span>{locale === 'es' ? 'Siguiente' : locale === 'fr' ? 'Suivant' : locale === 'pt' ? 'Seguinte' : 'Next'}</span>
