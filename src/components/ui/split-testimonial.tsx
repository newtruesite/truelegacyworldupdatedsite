...
export function TestimonialsSplit({
  ...
  const ui = {
    en: { story: 'Story', of: 'of', shared: 'shared with True Legacy', original: 'Original story', real: 'A real person.', personal: 'A personal message.', guide: 'Read the story as a conversation, then move to the next member of the community.', today: 'Today · personal experience', hello: 'Hi True Legacy, I wanted to share my experience…', delivered: 'Delivered', read: 'Read full story', experience: 'Individual experience', disclaimer: 'This is one person’s individual experience. Experiences and outcomes vary; no specific health improvement or income is guaranteed.' },
    es: { story: 'Historia', of: 'de', shared: 'compartida con True Legacy', original: 'Historia original', real: 'Una persona real.', personal: 'Un mensaje personal.', guide: 'Lee la historia como una conversación y después conoce al siguiente miembro de la comunidad.', today: 'Hoy · experiencia personal', hello: 'Hola True Legacy, quería compartir mi experiencia…', delivered: 'Entregado', read: 'Leer historia completa', experience: 'Experiencia individual', disclaimer: 'Esta es la experiencia individual de una persona. Las experiencias y los resultados varían; no se garantiza ninguna mejora específica de salud ni ingresos.' },
    fr: { story: 'Histoire', of: 'sur', shared: 'partagée avec True Legacy', original: 'Histoire originale', real: 'Une vraie personne.', personal: 'Un message personnel.', guide: 'Lisez cette histoire comme une conversation, puis découvrez le prochain membre de la communauté.', today: 'Aujourd’hui · expérience personnelle', hello: 'Bonjour True Legacy, je voulais partager mon expérience…', delivered: 'Distribué', read: 'Lire toute l’histoire', experience: 'Expérience individuelle', disclaimer: 'Il s’agit de l’expérience individuelle d’une personne. Les expériences et les résultats varient ; aucune amélioration de santé ni aucun revenu spécifique n’est garanti.' },
    pt: { story: 'História', of: 'de', shared: 'compartilhada com a True Legacy', original: 'História original', real: 'Uma pessoa real.', personal: 'Uma mensagem pessoal.', guide: 'Leia a história como uma conversa e depois conheça o próximo membro da comunidade.', today: 'Hoje · experiência pessoal', hello: 'Olá True Legacy, eu queria compartilhar minha experiência…', delivered: 'Entregue', read: 'Ler história completa', experience: 'Experiência individual', disclaimer: 'Esta é a experiência individual de uma pessoa. Experiências e resultados variam; nenhuma melhoria específica de saúde ou renda é garantida.' },
  }[locale];
