...
// Pin positions: dot on map pin, label below (tuned to world-map-hero.png)
const PINS: PinConfig[] = [
  { id: 'north-america', label: 'North America', top: '38%', left: '24%', route: '/region/north-america' },
  { id: 'south-america', label: 'Latin America', top: '70%', left: '30%', route: '/region/latin-america' },
  { id: 'africa', label: 'Africa', top: '55%', left: '52%', route: '/region/africa' },
]
  ...
  return (
    ...
    >
      ...
      <img
        ...
        aria-hidden
      />
      {/* Dot centered on the map pin */}
      <span className="flex shrink-0 -translate-y-1/2">
        <svg className="w-4 h-4 text-[#F5A623] drop-shadow-md" viewBox="0 0 16 16" fill="currentColor" aria-hidden>
