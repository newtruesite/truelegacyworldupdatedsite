...
import { LeadersModal } from '@/components/ui/LeadersModal'
  ...
  return (
    <section className={variant === 'home' ? 'py-20' : 'py-20'} style={{ background: variant === 'home' ? '#060b1e' : '#070c1a' }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className={variant === 'homeAll' ? 'products-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto' : 'products-grid grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto'}>
      ...
      <LeadersModal isOpen={leadersOpen} onClose={() => setLeadersOpen(false)} country={country} />
    </section>
  )
}
